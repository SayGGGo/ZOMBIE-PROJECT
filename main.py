...
if not check_file("ZOMBIE-PROJECT/background.png"):
    if not check_file("background.png"):
        print("[ZOMBIE PROJECT] Файлы игры не найдены, установка с GitHub...")
        path_full = "ZOMBIE-PROJECT/"
        if os.path.isdir(""):
...
class DialogueManager:
    def __init__(self, dialogue_file):
        ...
        self.sound = 0
        self.weapons = {
            "ak47": Weapon("AK-47", 2, 10, 120, ORANGE, 15, 5, True, 23000, "ak47"),
            "mosina": Weapon("Мосина", 10, 0.5, 10, PURPLE, 20, 0, False, 20000, "mosina"),
...
boss = Enemy(8000, 400, 10)
boss.health = 20
boss.speed_x = 4
boss.rect = pygame.Rect(8000, 400, 80, 100)
enemies.append(boss)
